...
import com.aslifitness.fitrackers.databinding.ActivityCameraBinding
...
class CameraActivity: AppCompatActivity() {
    ...
    private fun takePhoto() {
        ...
        val fileName = SimpleDateFormat(FILENAME_FORMAT, Locale.getDefault()).format(System.currentTimeMillis())
        ...
        imageCapture.takePicture(outputOptions, ContextCompat.getMainExecutor(this),
            object : ImageCapture.OnImageSavedCallback {
                ...
                override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                    ...
                    Intent(this@CameraActivity, CameraSuccessActivity::class.java).apply {
                ...
                when(recordEvent) {
                    is VideoRecordEvent.Start -> {
                        binding.videoCaptureButton.apply {
                            text = getString(com.aslifitness.fitrackers.R.string.stop_capture)
                            isEnabled = true
                        }
                    }
